const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_RS_TUBER_F]          = _("FLOTTEUSE"),
    ...
    [TRAINER_CLASS_SCHOOL_KID]          = _("ÉLÈVE"),
    ...
    [TRAINER_CLASS_PKMN_TRAINER]        = _("DRESSEUR {PKMN}"),
    [TRAINER_CLASS_RS_PKMN_BREEDER]     = _("ELEVEUR {PKMN}"),
